...
- **[agenttrace](https://github.com/luoyuctl/agenttrace)**: Local CLI/TUI for replaying, diffing, and auditing AI coding-agent session history.
...
- **[ax](https://github.com/Necmttn/ax)**: Local telemetry for coding agents.
